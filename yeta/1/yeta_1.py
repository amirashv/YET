...
import libyeti24_v2 as yeti24  ## importing everything from the module
from libyeti24_v2 import draw_text  ## we will use this a lot

"""
The Yeti24 engine provides classes for measuring and recording ET data from both cameras,
